            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden w-auto max-w-fit mx-auto flex flex-col md:flex-row shadow-violet-500">
                ...
                <div class="w-full md:w-1/2 p-8">
                    ...
                    <form action="#">
                        ...
                        <div class="mb-6">
                            <button type="submit"
                                class="w-full bg-violet-500 text-white py-2 rounded-lg  focus:outline-none focus:ring-2 focus:ring-blue-500 hover:bg-violet-600 hover:drop-shadow-lg shadow-violet-950">Login</button>
                        </div>
                    </form>
